        ...
        <div v-for="spot in spots" :key="spot.id" class="spot-card">
          ...
          <div class="spot-details">
            ...
            <div class="button-group">
              <router-link :to="{ name: 'spotUpdate', params: { id: spot.id }}" class="update-button">Update</router-link>
            </div>
          </div>
        </div>
      </div>
...
export default {
  setup() {
    ...
    // Fetch spots when component is mounted
